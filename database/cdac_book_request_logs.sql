...
INSERT INTO `atc_book_request_logs` (`id`, `atc_code`, `book_code`, `book_received_count`, `book_dispatched_count`, `book_transaction_type`, `requested_entity_code`, `processed_dt`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
