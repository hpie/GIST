...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2017 at 06:00 PM
...
CREATE TABLE IF NOT EXISTS `cdac_entities` (
  ...
  `entity_type` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'ATC' COMMENT 'Either ATC, ARC or CDAC',
  `entity_grade` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Grade Mandatory for ATC A, B , C  D etc. Courses fee etc are dependent on it',
...
INSERT INTO `cdac_entities` (`entity_code`, `entity_name`, `entity_type`, `entity_grade`, `entity_parent_code`, `entity_address_line1`, `entity_address_line2`, `entity_address_city`, `entity_address_postcode`, `entity_contact_number`, `entity_contact_email`, `status`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
