...
--
-- Table structure for table `cdac_book_requests`
--

CREATE TABLE IF NOT EXISTS `cdac_book_requests` (
  `id` bigint(20) NOT NULL,
  `entity_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `requesting_to` varchar(50) COLLATE utf8_unicode_ci NOT NULL,  
...
--
-- Indexes for table `cdac_book_requests`
--
ALTER TABLE `cdac_book_requests`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `cdac_book_requests`
--
ALTER TABLE `cdac_book_requests`
...
--
-- Constraints for table `cdac_book_requests`
--
ALTER TABLE `cdac_book_requests`
  ADD CONSTRAINT `cdac_book_requests_ibfk_1` FOREIGN KEY (`entity_code`) REFERENCES `cdac_entities` (`entity_code`),
  ADD CONSTRAINT `atc_book_requests_ibfk_2` FOREIGN KEY (`book_code`) REFERENCES `cdac_books` (`book_code`),
ADD CONSTRAINT `atc_book_requests_ibfk_3` FOREIGN KEY (`requesting_to`) REFERENCES `cdac_entities` (`entity_code`)  ;
