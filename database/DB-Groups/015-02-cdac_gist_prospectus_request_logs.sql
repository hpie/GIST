...
INSERT INTO `cdac_book_request_logs` (`id`, `entity_code`, `prospectus_received_count`, `prospectus_dispatched_count`, `prospectus_transaction_type`, `to_entity_code`, `processed_dt`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
