...
drop table if exists  `entity_faculties`;

--
-- Table structure for table `entity_faculties`
--

CREATE TABLE IF NOT EXISTS `entity_faculties` (
...
--
-- Dumping data for table `entity_faculties`
--

INSERT INTO `entity_faculties` (`faculty_code`, `first_name`, `last_name`, `entity_code`, `faculty_joining_dt`, `faculty_leaving_dt`, `faculty_gender`, `faculty_mobile`, `faculty_email`, `faculty_dob`, `faculty_status`, `current_address_line1`, `current_address_line2`, `current_address_city`, `current_address_pincode`, `permanent_address_line1`, `permanent_address_line2`, `permanent_address_city`, `permanent_address_pincode`, `status`, `created_by`, `created_dt`, `modified_by`, `modified_dt`) VALUES
...
--
-- Indexes for table `entity_faculties`
--
ALTER TABLE `entity_faculties`
