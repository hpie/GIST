...
drop table if exists `atc_student_enrollments`;

--
-- Table structure for table `atc_student_enrollments`
--

CREATE TABLE IF NOT EXISTS `atc_student_enrollments` (
...
--
-- Indexes for table `atc_student_enrollments`
--
ALTER TABLE `atc_student_enrollments`
...
--
-- AUTO_INCREMENT for table `atc_student_enrollments`
--
ALTER TABLE `atc_student_enrollments`
