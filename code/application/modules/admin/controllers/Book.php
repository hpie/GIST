...
class Book extends Admin_Controller {
	...
	public function index()
	{
		...
		$crud->columns('book_code', 'book_name', 'book_description', 'book_status');
		...
		//Show only in ADD
		$crud->add_fields('book_code', 'book_name', 'book_description', 'book_status');
		
		//Show only for Update
		$crud->edit_fields('book_name', 'book_description', 'book_status');
