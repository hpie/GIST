...
<link rel="stylesheet" type="text/css" media="screen" href="https://cdnjs.cloudflare.com/ajax/libs/datepicker/0.6.3/datepicker.css" />
<script src="https://cdnjs.cloudflare.com/ajax/libs/datepicker/0.6.3/datepicker.min.js" type="text/javascript"></script>
...
<script type="text/javascript">
			 $(document).ready(function () {
			 	var lastsel;
				$("#list1").jqGrid({
		   		url:'<?php echo $base_url.'index.php/cdac/loadRegistrationData'?>',      //another controller function for generating data
					mtype : "post",             //Ajax request type. It also could be GET
					datatype: "json",            //supported formats XML, JSON or Arrray
		   			colNames:['Student ID','Student Name','Center Code', 'Documents', 'Registered Email','Registration Date'],       //Grid column headings
		   			colModel:[
				   		{name:'student_id',index:'student_id', width:30, align:"left"},
				   		{name:'first_name',index:'first_name', width:20, align:"left",  editable: true},
				   		{name:'atc_code',index:'atc_code', width:20, align:"left"},
				   		{name:'docs',index:'docs', width:20, align:"left",formatter:viewDocs},
				   		/*{name:'student_status',index:'student_status', width:30, align:"left"},*/
				   		{name:'registered_email',index:'registered_email', width:20, align:"left",  editable: true},
				   		{name:'admission_dt',index:'admission_dt', width:20, align:"right"},
		  			],
				   	rowNum:10,
				   	width: 1150,
				   	rowList:[10,20,30],
					...
					onCellSelect: function(rowid, iCol, cellcontent, e){ 
				      if(rowid && iCol == 1) { 				        
							...
							$("#listSingle").jqGrid({
					   		url:'<?php echo $base_url.'index.php/cdac/loadRegistrationDataSingle/'?>'+rowid,//another controller function for generating data
								mtype : "post", //Ajax request type. It also could be GET
								postData: {student_id:cellcontent},
								datatype: "json", //supported formats XML, JSON or Arrray
								...
								editurl: "<?php echo $base_url.'index.php/cdac/updateRegistrationDataSingle'?>",
							   	width: 850,
							...
							$("#studentModal").modal('show');
				      		...
				      		$.ajax({
				         	url:"<?php echo $base_url.'index.php/cdac/getStudentDocs'?>",
				         	type: "POST",
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Student Document Listinng</h4>				
				</div>
