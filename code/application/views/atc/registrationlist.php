...
<script type="text/javascript">
			 $(document).ready(function () {
			 	var lastsel;
				$("#list1").jqGrid({
		   		url:'<?php echo $base_url.'index.php/atc/loadRegistrationData'?>',      //another controller function for generating data
					...
					onCellSelect: function(rowid, iCol, cellcontent, e){ 
				      if(rowid && iCol == 1) { 				        
							...
							$("#listSingle").jqGrid({
					   		url:'<?php echo $base_url.'index.php/atc/loadRegistrationDataSingle/'?>'+rowid,//another controller function for generating data
								mtype : "post", //Ajax request type. It also could be GET
								...
								editurl: "<?php echo $base_url.'index.php/atc/updateRegistrationDataSingle'?>",
							   	width: 850,
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Student Document Listing</h4>				
				</div>
