...
jQuery("#listtable").jqGrid({
  url:'<?php echo $base_url.'index.php/atc/loadDocumentsData'?>',
  mtype : "post", 
  datatype: "json",
  height: 'auto',
  rowNum: 9,
  rowList: [3,6,9],
    ...
    */
    editurl: "<?php echo $base_url.'index.php/atc/Document_update'?>",
    postData:{q:1},
    pager: "#plisttable",
    viewrecords: true,
    sortname: 'id',
  ...
  function cancelEdit() {
   ...
   function UploadImage(){
       var formData = new FormData($("#docData")[0]);
        $.ajax({
            url: "<?php echo $base_url . 'index.php/atc/updatedoc' ?>",
            type: "POST",
            data: formData,
            dataType: 'json',
            processData: false,
