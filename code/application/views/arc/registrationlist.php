...
<script type="text/javascript">
			 $(document).ready(function () {
			 	var lastsel;
				$("#list1").jqGrid({
		   		url:'<?php echo $base_url.'index.php/arc/loadRegistrationData'?>',      //another controller function for generating data
					...
					onCellSelect: function(rowid, iCol, cellcontent, e){ 
				      if(rowid && iCol == 1) { 				        
							...
							$("#listSingle").jqGrid({
					   		url:'<?php echo $base_url.'index.php/arc/loadRegistrationDataSingle/'?>'+rowid,//another controller function for generating data
								mtype : "post", //Ajax request type. It also could be GET
								...
								editurl: "<?php echo $base_url.'index.php/arc/updateRegistrationDataSingle'?>",
							   	width: 850,
